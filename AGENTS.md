...
- **Standing Order:** If the project root lacks standard scaffolding (e.g., missing `src/` or `tailwind.config.js`):
  - **Action:** Execute `../react-native-boilerplate/init.sh`.
...
- **Branding:** Ensure the generated README.md contains the "React Native Boilerplate" project header if it is a new repository.
